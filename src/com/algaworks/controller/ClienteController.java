...
public class ClienteController implements Serializable {
	...
	private static final long serialVersionUID = -797479073513795526L;
	...
	public ClienteController() {
		...
		clientes.add(new Cliente("123.123.123-11", "João da Silva Albuquerque", "(34) 3238-1111", "(34) 9 9999-7716",
				"joao@algaworks.com", "Minas Gerais", new Date(), true, "Cliente especial\nÉ gente boa!",
				enderecosJoao));

		clientes.add(new Cliente("333.333.123-11", "Maria Abadia das Couves Teixeira", "(11) 4000-1234",
				"(11) 9 8888-1122", "maria@algaworks.com", "São Paulo", null, false, null, new ArrayList<>()));

		clientes.add(new Cliente("444.444.123-11", "Paula Maria de Souza Mendes", "(31) 2233-4455", "(31) 9 9433-2282",
				"paula@algaworks.com", "Minas Gerais", null, false, null, new ArrayList<>()));
	}
